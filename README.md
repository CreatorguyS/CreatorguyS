...
## 🛡️ The Architect's Profile

- 🎓 **Institutional Status**: 3rd Year B.Tech CSE at **NIT Jamshedpur**.
- 💡 **Core Mission**: Bridging the gap between complex AI logic and intuitive User Experience.
- 🏋️ **Personal OS**: Fueled by high-intensity gym sessions and high-spice culinary adventures.
- 🎨 **Creative Philosophy**: _"Aesthetic banane ka shauk hai"_ — I build code that performs and designs that inspire.
...
| :--- | :--- | :--- |
| **🛡️ PrivaShield AI** | Node.js, Gemini AI, Docker | Simplifies legal TOS into functional data permission maps. |
| **🍱 EcoFeast** | MERN, Socket.io, AI | Predictive platform to eliminate campus food wastage. |
| **📦 Smart Logistics** | Java, JDBC, Docker | High-concurrency system for real-time shipment tracking. |
